...
void loadScene()
{
	...
	A.block<1,4>(1,0) << 0.0f, 0.0f, 1.0f, 1.0f;
	b(1) = 0.0f;
	
	A.block<1,4>(2,0) << pow(0.4f, 3), pow(0.4f, 2), pow(0.4f, 1), 1.0f;
	A.block<1,4>(2,4) << -pow(0.4f, 3), -pow(0.4f, 2), -pow(0.4f, 1), -1.0f;
	b(2) = 0.0f;

	A.block<1,4>(3,0) << 3*pow(0.4f, 2), 2*0.4f, 1.0f, 1.0f;
	A.block<1,4>(3,4) << -3*pow(0.4f, 2), -2*0.4f, -1.0, -1.0f;
	b(3) = 0.0f;
	
	A.block<1,4>(4,4) << pow(0.5f, 3), pow(0.5f, 2), 0.5f, 1.0f;
	b(4) = 0.2f;
	
	A.block<1,4>(5,4) << 3*pow(0.5f, 2), 2*0.5f, 1.0f, 1.0f;
	b(5) = 0.0f;
	
	A.block<1,4>(6,4) << 1.0f, 1.0f, 1.0f, 1.0f;
	b(6) = 1.0f;
	
	A.block<1,4>(7,4) << 3.0f, 2.0f, 1.0f, 1.0f;
	b(7) = 0.0f;
	cout << A << endl;
	cout << b << endl;
